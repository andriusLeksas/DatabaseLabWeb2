...
{
    public class dbHuController : Controller
    {
        private readonly ILogger<dbHuController> _logger;
        public dbHuController(ILogger<dbHuController> logger)
        {
            _logger = logger;
        }
        ...
        {
            MongoCRUD dbHu = new MongoCRUD("DB33");
